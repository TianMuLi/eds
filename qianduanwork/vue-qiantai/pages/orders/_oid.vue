    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          ...
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《EDS学院购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
...
export default {
      ...
      return order.getOrderInfo(params.oid).then(res=>{
          return {
