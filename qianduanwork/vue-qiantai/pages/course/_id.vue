      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="courseWebVo.cover" height="357px" width="640px" :alt="courseWebVo.title" class="dis c-v-pic">
          </section>
        </article>
                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 文件目录 -->
                          <li class="lh-menu-stair" v-for="chapter in videoByCourseList" :key="chapter.id">
...
export default {
   data(){
     ...
     //生成订单
           ...
           getCommentList(){
              comment.getCommentList(1,8,this.courseId).then(res=>{
           ...
           getCourseInfo(){
             course.getCourseInfo(this.courseId).then(res=>{
              ...
              this.videoByCourseList=res.data.data.videoByCourseList
